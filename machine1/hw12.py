...
test2_data.loc[(test2_data['Sex'] == 1) & (test2_data['Pclass'] <= 2), 'Survived'] = 1
test2_data.loc[(test2_data['Age'] <= 10) | (test2_data['Age'] >= 80), 'Survived'] = 1
test2_data.loc[(test2_data['Pclass'] == 1) & (test2_data['Fare'] > 50), 'Survived'] = 1

test2_data.loc[test2_data.isnull().any(axis=1), 'Survived'] = np.nan

### save to csv

#PassengerId, Survived
submission = test2_data[['PassengerId', 'Survived']]

#save
submission.to_csv(r'C:\Users\for\Desktop\sc\24-2Graphics\machine1\1958015_submission.csv', index=False)
